...
$judul = 'Master Keahlian'; // Yang diganti
$uri = 'halaman/modul_admin/keahlian/'; // Yang diganti
?>
				...
				<form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="hidden" id="idKode<?php echo $var; ?>" name="txtKodeKeahlian" class="form-control" readonly>
							<input type="text" id="idNama<?php echo $var; ?>" name="txtNmKeahlian" placeholder="Nama Keahlian" class="form-control col-md-7 col-xs-12" required="required">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="idDeskripsi<?php echo $var; ?>">
							Deskripsi <span class="required">*</span>
						</label>
						<div class="col-md-5 col-sm-6 col-xs-12">
							<textarea id="idDeskripsi<?php echo $var; ?>" name="txtDeskripsi" placeholder="Deskripsi" class="form-control col-md-7 col-xs-12" rows="5" required="required"></textarea>
						</div>
					</div>
