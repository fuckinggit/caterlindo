...
$var = 'KategoriPekerjaan'; // Yang diganti
$judul = 'Kategori Pekerjaan'; // Yang diganti
$uri = 'halaman/modul_admin/kategori_pekerjaan/'; // Yang diganti
?>
			...
			<div class="x_content">
				...
				<form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="idKat<?php echo $var; ?>">
							Kategori Pekerjaan <span class="required">*</span>
						</label>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="hidden" id="idKd<?php echo $var; ?>" name="txtIdKategori">
							<input type="text" id="idKat<?php echo $var; ?>" name="txtKategori" class="form-control col-md-7 col-xs-12" placeholder="Kategori Pekerjaan" required="required">
						</div>
					</div>
