...
function reset() {
	...
	document.getElementById("idKat<?php echo $var; ?>").value = '';
}

function removeAtt() {
	document.getElementById("idKat<?php echo $var; ?>").removeAttribute("required");
}
...
function editForm(id){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $('#idKd<?php echo $var; ?>').val(data.kd_kat_pekerjaan);
            $('#idKat<?php echo $var; ?>').val(data.nm_kat_pekerjaan);
        }
    });
}
