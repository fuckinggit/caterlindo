...
function reset() {
	...
	document.getElementById("idUnit<?php echo $var; ?>").value = '';
	document.getElementById("idNama<?php echo $var; ?>").value = '';
}

function removeAtt() {
	document.getElementById("idUnit<?php echo $var; ?>").removeAttribute("required");
...
function editForm(id){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $('#idKd<?php echo $var; ?>').val(data.kd_bagian);
            $('#idUnit<?php echo $var; ?>').val(data.kd_unit);
            $('#idNama<?php echo $var; ?>').val(data.nm_bagian);
        }
    });
}
