...
function reset() {
	document.getElementById("idKdGaji<?php echo $var; ?>").value = '';
	document.getElementById("idNamaGaji<?php echo $var; ?>").value = '';
	document.getElementById("idMinJml<?php echo $var; ?>").value = '';
	document.getElementById("idMaxJml<?php echo $var; ?>").value = '';
}

function removeAtt() {
	document.getElementById("idKdGaji<?php echo $var; ?>").removeAttribute("required");
	document.getElementById("idNamaGaji<?php echo $var; ?>").removeAttribute("required");
	document.getElementById("idMinJml<?php echo $var; ?>").removeAttribute("required");
	document.getElementById("idMaxJml<?php echo $var; ?>").removeAttribute("required");
}
...
function editForm(id){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $('#idKdGaji<?php echo $var; ?>').val(data.kd_gaji);
            $('#idNamaGaji<?php echo $var; ?>').val(data.nm_gaji);
            $('#idMinJml<?php echo $var; ?>').val(data.min_gaji);
            $('#idMaxJml<?php echo $var; ?>').val(data.max_gaji);
        }
    });
}
