...
function reset() {
	...
	document.getElementById("idKet<?php echo $var; ?>").value = '';
}
...
function editForm(id){
    ...
    $.ajax({
        ...
        success:function(data){
			...
			$("#idKode<?php echo $var; ?>").val(data.id);
			$("#idNama<?php echo $var; ?>").val(data.tipe_ga);
			$("#idKet<?php echo $var; ?>").val(data.keterangan);
        }
    });
}
