<?php
$tbl = 'tb_tipe_ga';
$var = 'TipeGeneralAffair'; // Yang diganti
$judul = 'Master Tipe GA'; // Yang diganti
$uri = 'halaman/modul_admin/tipe_generalaffair/'; // Yang diganti
?>
				...
				<form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class="control-label col-md-2 col-sm-3 col-xs-12" for="idNama<?php echo $var; ?>">
							Tipe General Affair <span class="required">*</span>
						</label>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="hidden" id="idKode<?php echo $var; ?>" name="txtKode" class="form-control" readonly>
							<input type="text" id="idNama<?php echo $var; ?>" name="txtNm" placeholder="Tipe General Affair" class="form-control col-md-7 col-xs-12" required="required">
						</div>
					</div>
					
					<div class="form-group">
						<label class="control-label col-md-2 col-sm-2 col-xs-12" for="idKet<?php echo $var; ?>">
							Keterangan 
						</label>
						<div class="col-md-4 col-sm-12 col-xs-12">
							<textarea id="idKet<?php echo $var; ?>" name="txtKet" class="form-control"></textarea>
						</div>
					</div>
