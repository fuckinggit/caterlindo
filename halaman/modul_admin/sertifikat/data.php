<?php
$tbl = 'tb_sertifikasi';
$var = 'Sertifikasi'; // Yang diganti
$judul = 'Master Sertifikat'; // Yang diganti
$uri = 'halaman/modul_admin/sertifikat/'; // Yang diganti
?>
				...
				<form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							...
							<input type="text" id="idNama<?php echo $var; ?>" name="txtNm" placeholder="Nama Sertifikat" class="form-control col-md-7 col-xs-12" required="required">
						</div>
					</div>
