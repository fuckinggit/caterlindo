...
function reset() {
	document.getElementById("idTgl<?php echo $var; ?>").value = '';
	document.getElementById("idDeskripsi<?php echo $var; ?>").value = '';
}

function removeAtt() {
	document.getElementById("idTgl<?php echo $var; ?>").removeAttribute("required");
...
function editForm(id){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $('#idTgl<?php echo $var; ?>').val(data.tgl_libur);
