					...
					<div class="col-lg-3 col-md-3 col-sm-3 mb">
						...
						<a href="#tak_klik_form_edit foto">
							<div style="margin-bottom:5px;" class="content-panel pn">
								<div id="profile-02">
									<div class="user">
										<img src="assets/img/karyawan/<?php echo $detail['pas_foto']; ?>" class="img-circle" width="150">
					...
					<div class="col-lg-9 col-md-9 col-sm-9 mb" style="margin-left:-15px; width:76%;">
						<div class="row">
							...
							if (!isset($_GET['menu']) || (isset($_GET['menu']) && $_GET['menu'] == 'data_pribadi')) {
								...
								include_once 'jabatan/detail_jabatan.php';
							} if ($_GET['menu'] == 'gaji') {
								include_once 'gaji/detail_gaji.php';
