...
Date: 2016-11-24 04:01:17
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `tab_absensi`
-- ----------------------------
DROP TABLE IF EXISTS `tab_absensi`;
CREATE TABLE `tab_absensi` (
  `PersonalLogID` int(20) NOT NULL AUTO_INCREMENT,
  `kd_karyawan` varchar(4) NOT NULL,
  `TerminalID` varchar(30) NOT NULL,
  `FingerPrintID` varchar(30) NOT NULL,
  `DateLog` datetime NOT NULL,
  `TimeLog` varchar(50) NOT NULL,
  `VerifyMode` int(20) NOT NULL,
  `FunctionKey` int(20) NOT NULL,
  `Edited` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `UserName` varchar(50) NOT NULL,
  `FlagAbsence` varchar(50) NOT NULL,
  `DateTime` datetime NOT NULL,
  `EmployeeStatus` varchar(100) NOT NULL,
  `FunctionKeyEdited` int(50) NOT NULL,
  `PersonalLogStatus` varchar(50) NOT NULL,
  PRIMARY KEY (`PersonalLogID`)
) ENGINE=InnoDB AUTO_INCREMENT=21576 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tab_absensi
-- ----------------------------
INSERT INTO `tab_absensi` VALUES ('21556', '', '-1', '20559', '2015-08-18 00:00:00', '15:21', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-18 15:21:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21557', '', '-1', '20559', '2015-08-18 00:00:00', '23:31', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-18 23:31:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21558', '', '-1', '20559', '2015-08-19 00:00:00', '14:46', '1', '1', '0000-00-00 00:00:00', '', 'Device', '2015-08-19 14:46:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21559', '', '-1', '20559', '2015-08-19 00:00:00', '23:31', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-19 23:31:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21560', '', '-1', '20559', '2015-08-20 00:00:00', '14:45', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-20 14:45:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21561', '', '-1', '20559', '2015-08-20 00:00:00', '23:33', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-20 23:33:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21562', '', '-1', '20559', '2015-08-21 00:00:00', '14:39', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-21 14:39:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21563', '', '-1', '20559', '2015-08-21 00:00:00', '23:32', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-21 23:32:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21564', '', '-1', '20559', '2015-08-22 00:00:00', '14:06', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-22 14:06:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21565', '', '-1', '20559', '2015-08-22 00:00:00', '22:01', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-22 22:01:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21566', '', '-1', '20559', '2015-08-24 00:00:00', '06:45', '1', '0', '0000-00-00 00:00:00', '', 'Device', '2015-08-24 06:45:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21567', '', '-1', '20559', '2015-08-24 00:00:00', '15:35', '1', '1', '0000-00-00 00:00:00', '', 'Device', '2015-08-24 15:35:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21568', '', '-1', '20559', '2015-08-25 00:00:00', '06:49', '1', '4', '0000-00-00 00:00:00', '', 'Device', '2015-08-25 06:49:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21569', '', '-1', '20559', '2015-08-25 00:00:00', '15:37', '1', '4', '0000-00-00 00:00:00', '', 'Device', '2015-08-25 15:37:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21570', '', '-1', '20559', '2015-08-26 00:00:00', '06:49', '1', '7', '0000-00-00 00:00:00', '', 'Device', '2015-08-26 06:49:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21571', '', '-1', '20559', '2015-08-26 00:00:00', '15:35', '1', '7', '0000-00-00 00:00:00', '', 'Device', '2015-08-26 15:35:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21572', '', '-1', '20559', '2015-08-27 00:00:00', '06:48', '1', '7', '0000-00-00 00:00:00', '', 'Device', '2015-08-27 06:48:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21573', '', '-1', '20559', '2015-08-27 00:00:00', '15:37', '1', '7', '0000-00-00 00:00:00', '', 'Device', '2015-08-27 15:37:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21574', '', '-1', '20559', '2015-08-28 00:00:00', '06:48', '1', '1', '0000-00-00 00:00:00', '', 'Device', '2015-08-28 06:48:00', 'NoData', '0', 'Process');
INSERT INTO `tab_absensi` VALUES ('21575', '', '-1', '20559', '2015-08-28 00:00:00', '15:34', '1', '7', '0000-00-00 00:00:00', '', 'Device', '2015-08-28 15:34:00', 'NoData', '0', 'Process');

-- ----------------------------
-- Table structure for `tab_absensi_new`
-- ----------------------------
DROP TABLE IF EXISTS `tab_absensi_new`;
CREATE TABLE `tab_absensi_new` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kd_karyawan` varchar(20) NOT NULL DEFAULT '',
  `tgl_kerja` date DEFAULT NULL,
  `jam_masuk` time DEFAULT NULL,
  `jam_keluar` time DEFAULT NULL,
  `status_masuk` varchar(30) DEFAULT NULL,
  `keterangan_masuk` text,
  `status_keluar` varchar(30) DEFAULT NULL,
  `keterangan_keluar` text,
  `status_upload` int(1) DEFAULT NULL,
  `kd_shift` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`id`,`kd_karyawan`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tab_absensi_new
-- ----------------------------
INSERT INTO `tab_absensi_new` VALUES ('1', '001', '2016-11-01', '07:00:00', '07:23:31', 'Masuk', 'Telat', 'Pulang', 'Pulang On Time', '0', 'A');
...
-- Records of tb_admin
-- ----------------------------
INSERT INTO `tb_admin` VALUES ('1', '001', '0', '', 'admin', '21232f297a57a5a743894a0e4a801fc3', '1', '09-11-2016', null, 'ju0k3mo094asmp242c3hqmp0a2');
...
INSERT INTO `tb_hakaksesuser` VALUES ('11', '0', '20', '', '', 'ADMIN');
...
-- ----------------------------
-- Table structure for `tb_jadwal_karyawan`
-- ----------------------------
DROP TABLE IF EXISTS `tb_jadwal_karyawan`;
CREATE TABLE `tb_jadwal_karyawan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kd_karyawan` int(50) DEFAULT NULL,
  `kd_shift` varchar(11) DEFAULT NULL,
...
INSERT INTO `tb_menu` VALUES ('6', '10', 'Logout', '?p=logout', 'LOGOUT', 'fa fa-sign-out', 'Y');
...
INSERT INTO `tb_menu` VALUES ('20', '9', 'Manajemen Karyawan', 'javascript:;', 'Manajemen Karyawan', 'fa fa-newspaper-o', 'Y');
...
INSERT INTO `tb_submenu` VALUES ('16', '20', '1', 'Schedule', '?p=schedule', 'Schedule', null, 'Y');
INSERT INTO `tb_submenu` VALUES ('17', '20', '2', 'Absensi', '?p=absensi', 'Absensi', null, 'Y');
...
INSERT INTO `tb_unit` VALUES ('4', '03', 'Makan');
